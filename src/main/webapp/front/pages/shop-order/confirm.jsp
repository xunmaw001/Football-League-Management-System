...
<html>
	...
	<body>
		<div id="app">
			...
			<!-- 标题 -->
			<div id="breadcrumb">
				<span class="en">CONFIRM / ORDER</span>
				<span class="cn">确认下单</span>
			</div>
			<!-- 标题 -->
			...
			<div class="container">
                ...
                <div style="display: flex;align-items: center;">
                    <span>备注：</span><input type="text" name="remark" style="line-height: 40px;height: 40px;padding: 0 12px;flex: 1;" />
                </div>
