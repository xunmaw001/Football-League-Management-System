		...
		<script>
			...
			layui.use(['form', 'layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate', 'slider'], function() {
				...
				http.request('config/list', 'get', {
			        ...
			        vue.shengfuduiwuOptions = '主队,客队'.split(',')
				...
				if (jquery('#bisaimingcheng').val()) {
					...
					// 获取列表数据
					http.request('jingcaixinxi/list', 'get', param, function(res) {
