	...
	<body>
		<div id="app">
			...
			<div class="recommend" :style='{"padding":"0","margin":"0px auto","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230202/738791e5d58a4645a4ee25591f67fcca.jpg) no-repeat left top / 600px auto,url(http://codegen.caihongy.cn/20230202/8ab48bc29535492eb17dd1756fd6f963.jpg) no-repeat right bottom / 600px auto","display":"flex","width":"100%","position":"relative"}'>
				<div class="category-1" :style='{"border":"0px solid #bdefb6","padding":"0px 7% 0px","boxShadow":"inset 0px 0px 0px 0px #c5f1c0","margin":"40px 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"center","height":"auto"}'>
					<div class="category-search" :index="-1" :style='swiperIndex == -1 ? {"cursor":"pointer","boxShadow":"inset 0px 0px 60px 0px #f7bdbd","margin":"0 10px 10px 0","borderColor":"#e85151 #e99595 #e99595","color":"#333","textAlign":"center","minWidth":"110px","borderRadius":"0 30px 0px 0px","background":"#fff","borderWidth":"6px 6px  0px 0px","width":"auto","lineHeight":"45px","fontSize":"15px","borderStyle":"solid"} : {"cursor":"pointer","padding":"0 10px","boxShadow":"inset 0px 0px 60px 0px #f7bdbd","margin":"0 10px 10px 0","borderColor":"#e99595 #e99595 #e85151","color":"#333","textAlign":"center","minWidth":"110px","borderRadius":"0 0px 0px 30px","background":"#fff","borderWidth":"0px 0px 6px 6px ","width":"auto","lineHeight":"45px","fontSize":"15px","borderStyle":"solid","height":"51px"}'>全部</div>
					<div class="category-search" :index="index" :style='swiperIndex == index ? {"cursor":"pointer","boxShadow":"inset 0px 0px 60px 0px #f7bdbd","margin":"0 10px 10px 0","borderColor":"#e85151 #e99595 #e99595","color":"#333","textAlign":"center","minWidth":"110px","borderRadius":"0 30px 0px 0px","background":"#fff","borderWidth":"6px 6px  0px 0px","width":"auto","lineHeight":"45px","fontSize":"15px","borderStyle":"solid"} : {"cursor":"pointer","padding":"0 10px","boxShadow":"inset 0px 0px 60px 0px #f7bdbd","margin":"0 10px 10px 0","borderColor":"#e99595 #e99595 #e85151","color":"#333","textAlign":"center","minWidth":"110px","borderRadius":"0 0px 0px 30px","background":"#fff","borderWidth":"0px 0px 6px 6px ","width":"auto","lineHeight":"45px","fontSize":"15px","borderStyle":"solid","height":"51px"}' v-for="(item,index) in categoryList" :key="index">
						{{categoryList[index]}}
					</div>
				</div>
				...
				<form class="layui-form filter" :style='{"padding":"30px 7% 0","alignItems":"center","background":"none","display":"flex","width":"100%","justifyContent":"center","height":"auto"}'>
					...
					<div :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}' class="item-list">
						...
						<input type="text" :style='{"border":"1px dashed #ccc","padding":"0 10px","boxShadow":"0px 0px 0px #ccc","margin":"0","outline":"none","color":"#666","borderRadius":"0px","width":"140px","fontSize":"14px","lineHeight":"40px","height":"40px"}' name="shangpinmingcheng" id="shangpinmingcheng" placeholder="商品名称" autocomplete="off" class="layui-input">
					</div>
					<div :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}' class="item-list">
						<div class="lable" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px"}'>生产地</div>
						<input type="text" :style='{"border":"1px dashed #ccc","padding":"0 10px","boxShadow":"0px 0px 0px #ccc","margin":"0","outline":"none","color":"#666","borderRadius":"0px","width":"140px","fontSize":"14px","lineHeight":"40px","height":"40px"}' name="shengchandi" id="shengchandi" placeholder="生产地" autocomplete="off" class="layui-input">
					</div>
					<div :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}' class="item-list">
						<div class="lable" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px"}'>价格</div>
						<input type="text" :style='{"border":"1px dashed #ccc","padding":"0 10px","boxShadow":"0px 0px 0px #ccc","margin":"0","outline":"none","color":"#666","borderRadius":"0px","width":"150px","fontSize":"14px","lineHeight":"40px","height":"40px"}' name="pricestart" id="pricestart" placeholder="最小价格" autocomplete="off" class="layui-input">
						...
						<input type="text" :style='{"border":"1px dashed #ccc","padding":"0 10px","boxShadow":"0px 0px 0px #ccc","margin":"0","outline":"none","color":"#666","borderRadius":"0px","width":"150px","fontSize":"14px","lineHeight":"40px","height":"40px"}' name="priceend" id="priceend" placeholder="最大价格" autocomplete="off" class="layui-input">
					</div>
				...
				<div :style='{"padding":"20px 7% 20px","margin":"20px 0 10px","background":"none","flex":"1","width":"calc(93% - 200px)","minWidth":"900px","order":"3"}' class="lists">
					...
					<div :style='{"padding":"0 0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}' class="list list-2">
						<div :style='{"padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 20px","borderColor":"#ddd","display":"flex","justifyContent":"space-between","flexWrap":"wrap","background":"none","borderWidth":"0px","width":"49%","position":"relative","borderStyle":"solid","height":"240px"}' @click="jump('../gouwushangcheng/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" :key="index" class="list-item animation-box">
							<img :style='{"cursor":"pointer","verticalAlign":"middle","padding":"4px","borderColor":"#9dcde9","objectFit":"cover","borderWidth":"0px","background":"url(http://codegen.caihongy.cn/20230201/e692aea55f98482aaa7f0290e1888901.png) no-repeat center top / 100% 100%","display":"inline-block","width":"48%","borderStyle":"dotted","height":"100%"}' :src="item.shangpintupian?baseurl+item.shangpintupian.split(',')[0]:''">
		...
		<script>
			...
			layui.use(['form', 'layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate', 'slider'], function() {
				...
				if (jquery('#price').val()) {
					param['price'] = jquery('#price').val() ? '%' + jquery('#price').val() + '%' : '';
				}  

					// 获取列表数据
					http.request('gouwushangcheng/list', 'get', param, function(res) {
