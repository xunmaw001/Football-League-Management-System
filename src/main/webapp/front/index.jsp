...
<html>
	...
	<body>
	<div id="apps">
		<div id="header" :style='{"boxShadow":"0 0px 0px rgba(90, 180, 80, .2)","padding":"0px","alignItems":"center","display":"flex","right":"0","justifyContent":"flex-end","overflow":"hidden","top":"0","left":"0","background":"#fff","position":"fixed","height":"64px","zIndex":"1002"}'>
			...
			<div v-if="projectName" :style='{"margin":"0 7% 0 7%","color":"#333","textAlign":"center","background":"none","width":"86%","lineHeight":"68px","fontSize":"22px","position":"absolute","height":"44px"}' class="nav-top-title">{{projectName}}</div>
			<div :style='{"width":"50%","margin":"0 7% 0 0","alignItems":"center","textAlign":"right","display":"block","zIndex":"3333"}'>
				<div :style='{"color":"#666","fontSize":"14px","display":"inline-block"}'></div>
				<button v-if="!Token" :style='{"border":"0px solid #bdefb6","cursor":"pointer","padding":"0 20px","boxShadow":"inset 0px 0px 0px 0px #c5f1c0","margin":"0 0 0 10px","color":"#fff","display":"inline-block","minWidth":"80px","borderRadius":"2px","background":"#f50000","fontSize":"14px","lineHeight":"32px","height":"32px"}' @click="jumpLogin('./pages/login/login.jsp')">登录/注册</button>
				<button v-if="Token" :style='{"border":"0px solid #ddd","cursor":"pointer","padding":"0 20px","boxShadow":"inset 0px 0px 0px 0px #eee","margin":"0 0 0 10px","color":"#666","display":"inline-block","minWidth":"80px","borderRadius":"2px","background":"#eee","fontSize":"14px","lineHeight":"32px","height":"32px"}' @click="logout()">退出</button>
			</div>
		</div>
		
		
		<!-- 横向 -->
		<div id="navs" class="horizontal" :style='{"padding":"0","margin":"64px auto 0px","background":"none","width":"100%","position":"fixed","height":"68px","zIndex":"999"}'>
			<ul class="layui-nav" lay-bar="disabled" :style='{"border":0,"padding":"23px 0 0","listStyle":"none","margin":"0","borderColor":"#249940","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230201/e98c07973d584e74b42a07154ffa1899.jpg) no-repeat center top / auto 100%","borderWidth":"0 0 0px","position":"relative","borderStyle":"solid","height":"100%"}'>
		...
		<div id="tabbar" class="tabbar" :style='{"minHeight":"150px","padding":"20px 0","borderColor":"#cfa66a","margin":"0 auto","alignItems":"center","background":"#333","flexDirection":"column","borderWidth":"0px 0 0","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"center"}'>
