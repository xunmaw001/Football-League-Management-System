...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">商品分类管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>商品分类管理</span></li>
				<li class="breadcrumb-item-two"><span>商品分类列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>商品分类</label>
					<input type="text" id="shangpinfenleiSearch" class="form-control form-control-sm" placeholder="请输入商品分类" aria-controls="tableId">
				</div>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#shangpinfenleiSearch').val() != null && $('#shangpinfenleiSearch').val() != ''){
				searchForm.shangpinfenlei ="%" +  $('#shangpinfenleiSearch').val() + "%";
			}
