		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					...
					<input id="shengfuduiwu" name="shengfuduiwu" class="form-control" v-model="ruleForm.shengfuduiwu" readonly>
				</div>
				<div class="form-item">
					<label>用户账号</label>
				...
				<div class="form-item">
					...
					<input id="jingcaishijian" name="jingcaishijian" class="form-control" v-model="ruleForm.jingcaishijian" readonly>
				</div>
				<div class="form-item">
					<label>是否审核</label>
