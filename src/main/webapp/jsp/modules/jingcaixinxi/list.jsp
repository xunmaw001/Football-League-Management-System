...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">竞猜信息管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>竞猜信息列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('shengfuduiwu')">胜负队伍<i id="shengfuduiwuIcon" class="fa fa-sort"></i></th>
						...
						<th onclick="sort('jingcaishijian')">竞猜时间<i id="jingcaishijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var shengfuduiwuCell  = document.createElement('td');

						 shengfuduiwuCell.innerHTML = item.shengfuduiwu;

			row.appendChild(shengfuduiwuCell);
			...
			var jingcaishijianCell  = document.createElement('td');

						  jingcaishijianCell.innerHTML = item.jingcaishijian;


			row.appendChild(jingcaishijianCell);
		...
		function sh(){
			...
			httpJson("jingcaixinxi/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jingcaixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"jingcaixinxi");
