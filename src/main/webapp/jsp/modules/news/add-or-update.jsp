...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑公告资讯</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>公告资讯管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑公告资讯</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>简介</label>
					<textarea  name="introduction" class="form-control textarea" id="introduction" rows="3"></textarea>
				</div>
