...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑论坛</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>论坛管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑论坛</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>帖子标题</label>
					<input name="title" id="title" name="title" class="form-control" placeholder="请输入帖子标题">
				</div>
				<div class="form-item">
					<label>状态</label>
