...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">球员信息评论表管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>球员信息评论表列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var avatarurlCell  = document.createElement('td');

			            var avatarurlImg = document.createElement('img');
            avatarurlImg.setAttribute('src',item.avatarurl?(baseUrl+item.avatarurl.split(",")[0]):'');
			avatarurlImg.setAttribute('height',100);
			avatarurlImg.setAttribute('width',100);
			avatarurlCell.appendChild(avatarurlImg);


			row.appendChild(avatarurlCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("discussqiuyuanxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"discussqiuyuanxinxi");
